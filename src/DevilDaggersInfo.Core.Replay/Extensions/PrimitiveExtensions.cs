...
{
	public static DaggerType ToDaggerType(this byte value)
	{
		return value switch
		{
	...
	public static BoidType ToBoidType(this byte value)
	{
		return value switch
		{
	...
	public static ShootType ToShootType(this byte value)
	{
		return value switch
		{
			0x00 => ShootType.None,
	...
	public static JumpType ToJumpType(this byte value)
	{
		return value switch
		{
			0x00 => JumpType.None,
