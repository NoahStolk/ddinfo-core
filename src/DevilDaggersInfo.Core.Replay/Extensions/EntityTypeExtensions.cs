...
public static class EntityTypeExtensions
{
	...
	public static DaggerType GetDaggerType(this EntityType entityType)
	{
	...
	public static int GetInitialHp(this EntityType entityType)
	{
		return entityType switch
		{
			EntityType.Skull1 => 1,
	...
	private static bool IsWeakPoint(this EntityType entityType, int userData)
	{
		return entityType switch
		{
	...
	public static int GetInitialTransmuteHp(this EntityType entityType)
	{
		return entityType switch
		{
