...
{
	public static int GetNoFarmGems(this EnemyType enemyType)
	{
	...
	public static Color GetColor(this EnemyType enemyType, GameVersion gameVersion)
	{
		return enemyType switch
		{
	...
	public static string GetName(this EnemyType enemyType, GameVersion gameVersion)
	{
		return enemyType switch
		{
