...
public static class EnemyTypeExtensions
{
	extension(EnemyType enemyType)
	{
		...
		public Color GetColor(GameVersion gameVersion)
		{
			return enemyType switch
			{
				...
				EnemyType.Thorn => gameVersion switch
				{
					GameVersion.V3_0 or GameVersion.V3_1 or GameVersion.V3_2 => EnemyColors.Thorn,
					GameVersion.V2_0 => EnemyColors.Andras,
		...
		public string GetName(GameVersion gameVersion)
		{
			return enemyType switch
			{
				...
				EnemyType.Thorn => gameVersion switch
				{
					GameVersion.V3_0 or GameVersion.V3_1 or GameVersion.V3_2 => EnemiesV3_2.Thorn.Name,
					GameVersion.V2_0 => EnemiesV2_0.Andras.Name,
					_ => "Unsupported",
				},
