...
{
	public static readonly Enemy Squid1 = new(GameVersion.V3_2, "Squid I", EnemyColors.Squid1, 10, 1, 2, DeathsV3_2.Purged, new(10, 10, 10), 3);
	public static readonly Enemy Squid2 = new(GameVersion.V3_2, "Squid II", EnemyColors.Squid2, 20, 2, 3, DeathsV3_2.Desecrated, new(10, 10, 10), 39);
	public static readonly Enemy Squid3 = new(GameVersion.V3_2, "Squid III", EnemyColors.Squid3, 90, 3, 3, DeathsV3_2.Sacrificed, new(30, 10, 10), 244);
	...
	public static readonly Enemy Leviathan = new(GameVersion.V3_2, "Leviathan", EnemyColors.Leviathan, 1500, 6, 6, DeathsV3_2.Incarnated, new(1, 1, 0), 350); // TODO: Find out if splash or homing dagger deals the damage using replays.
	public static readonly Enemy Spider1 = new(GameVersion.V3_2, "Spider I", EnemyColors.Spider1, 25, 1, 1, DeathsV3_2.Intoxicated, new(10, 0, 10), 39); // TODO: Find out if splash or homing dagger deals the damage using replays.
	public static readonly Enemy Spider2 = new(GameVersion.V3_2, "Spider II", EnemyColors.Spider2, 200, 1, 1, DeathsV3_2.Envenomated, new(10, 0, 10), 274); // TODO: Find out if splash or homing dagger deals the damage using replays.
	public static readonly Enemy Thorn = new(GameVersion.V3_2, "Thorn", EnemyColors.Thorn, 120, 0, 0, DeathsV3_2.Entangled, new(10, 1, 10), 447);
	public static readonly Enemy TheOrb = new(GameVersion.V3_2, "The Orb", EnemyColors.TheOrb, 2400, 0, 0, DeathsV3_2.Discarnated, new(1, 1, 0), null, Leviathan); // TODO: Find out if splash or homing dagger deals the damage using replays.
