...
internal sealed class SpawnsViewTests
{
	...
	public async Task TestSpawnsView_V0()
	{
		...
		await AreEqual(new SpawnView(EnemyType.Squid1, 3, 2, new GemState(HandLevel.Level1, 2, 2)), spawnsView.PreLoop[0]);
		await AreEqual(new SpawnView(EnemyType.Squid1, 14, 2, new GemState(HandLevel.Level1, 4, 4)), spawnsView.PreLoop[1]);

		await AreEqual(new SpawnView(EnemyType.Squid2, 300, 3, new GemState(HandLevel.Level3, 111, 181)), spawnsView.Waves[0][0]);
		await AreEqual(new SpawnView(EnemyType.Squid2, 300, 3, new GemState(HandLevel.Level3, 114, 184)), spawnsView.Waves[0][1]);
	}
	...
	public async Task TestSpawnsView_V2()
	{
		...
		await AreEqual(new SpawnView(EnemyType.Squid3, 397, 3, new GemState(HandLevel.Level4, 132, 352)), spawnsView.Waves[0][0]);
		await AreEqual(new SpawnView(EnemyType.Squid2, 403, 3, new GemState(HandLevel.Level4, 135, 355)), spawnsView.Waves[0][1]);

		await AreEqual(new SpawnView(EnemyType.Gigapede, 415, 50, new GemState(HandLevel.Level4, 187, 407)), spawnsView.Waves[0][3]);
		await AreEqual(new SpawnView(EnemyType.Gigapede, 468.5667f, 50, new GemState(HandLevel.Level4, 272, 492)), spawnsView.Waves[1][3]);
		await AreEqual(new SpawnView(EnemyType.Gigapede, 516.5667f, 50, new GemState(HandLevel.Level4, 357, 577)), spawnsView.Waves[2][3]);
	}
	...
	public async Task TestSpawnsView_V2_In_V3()
	{
		...
		await AreEqual(new SpawnView(EnemyType.Gigapede, 415, 50, new GemState(HandLevel.Level4, 187, 407)), spawnsView.Waves[0][3]);
		await AreEqual(new SpawnView(EnemyType.Gigapede, 468.5667f, 50, new GemState(HandLevel.Level4, 272, 492)), spawnsView.Waves[1][3]);
		await AreEqual(new SpawnView(EnemyType.Ghostpede, 516.5667f, 10, new GemState(HandLevel.Level4, 317, 537)), spawnsView.Waves[2][3]);
	}
	...
	public async Task TestSpawns_PracticeSettings()
	{
		...
		await Assert.That(spawnsView.PreLoop[0].GemState).IsEqualTo(new GemState(HandLevel.Level1, 2, 2));
		...
		spawnsView = new SpawnsView(spawnset, gameVersion, waveCount);
		...
		await Assert.That(spawnsView.PreLoop[0].Seconds).IsEqualTo(3);
		await Assert.That(spawnsView.PreLoop[0].GemState).IsEqualTo(new GemState(HandLevel.Level2, 17, 2));
