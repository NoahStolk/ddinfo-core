...
public class EnemyTests
{
	...
	public void TestTransmutedSkull1HomingDamage()
	{
		foreach (GameVersion gameVersion in Enum.GetValues<GameVersion>())
		{
			...
			Assert.IsNotNull(originalTransmutedSkull1.HomingDamage.Level3HomingDamage);
			Assert.AreEqual(10, originalTransmutedSkull1.HomingDamage.Level3HomingDamage);
			Assert.AreEqual(1, originalTransmutedSkull1.HomingDamage.Level4HomingDamage);
		}
		...
		Assert.AreEqual(10, fixedTransmutedSkull1.HomingDamage.Level3HomingDamage);
		Assert.AreEqual(10, fixedTransmutedSkull1.HomingDamage.Level4HomingDamage);

		// TODO: Find splash damage.
	}
}
