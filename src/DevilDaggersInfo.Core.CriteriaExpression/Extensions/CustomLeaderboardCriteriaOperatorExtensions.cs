...
{
	public static string Display(this CustomLeaderboardCriteriaOperator criteriaOperator)
	{
	...
	public static string Description(this CustomLeaderboardCriteriaOperator criteriaOperator)
	{
		return criteriaOperator switch
		{
	...
	public static string ShortString(this CustomLeaderboardCriteriaOperator criteriaOperator)
	{
		return criteriaOperator switch
		{
