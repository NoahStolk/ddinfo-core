...
{
	public static string Display(this CustomLeaderboardCriteriaType criteriaType)
	{
	...
	public static string GetIdentifier(this CustomLeaderboardCriteriaType criteriaType)
	{
		return criteriaType switch
		{
	...
	public static string ToStringFast(this CustomLeaderboardCriteriaType criteriaType)
	{
		return criteriaType switch
		{
